...
XGBoost obtuvo el mejor desempeño en todas las métricas (tabla en Cap. 5), seguido por Random Forest y Lasso. Su superioridad sobre Lasso confirma que la relación precio-predictores **no es lineal**. La baja desviación estándar en la CV de 5 pliegues confirma buena generalización.

...
| **OE7** — Modelos predictivos | XGBoost es el mejor modelo (mayor R², menor RMSE y MAE). CV de 5 pliegues confirma estabilidad. |
...
| Estimación de precio de mercado | El modelo XGBoost puede usarse como herramienta de referencia (margen ≈ ±MAE dólares). |
